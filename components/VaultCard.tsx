      ...
      {isExpanded && (
        <div className="border-t border-gray-200 pt-3 sm:pt-4 space-y-3 sm:space-y-4 flex-1">
          ...
          {isConnected && (
            <div className="bg-gray-50 rounded-lg p-2 sm:p-3">
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium text-xs sm:text-sm truncate ml-2">{userBalance} STT</span>
              </div>
              <div className="flex justify-between items-center mt-1">
                <span className="text-xs sm:text-sm text-gray-600">Accrued Interest:</span>
                <span className="font-medium text-green-600 text-xs sm:text-sm truncate ml-2">{accruedInterest} STT</span>
              </div>
            </div>
          )}
          ...
          {!isConnected && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-2 sm:p-3">
              <div className="flex items-center">
                <svg className="w-3 h-3 sm:w-4 sm:h-4 text-yellow-500 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                </svg>
                <span className="text-xs sm:text-sm text-yellow-700">
                  <strong>Connect your wallet</strong> to deposit and withdraw on Somnia testnet
                </span>
              </div>
            </div>
          )}
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-2 sm:p-3">
            <div className="flex items-center">
              ...
              <span className="text-xs sm:text-sm text-green-700">
                <strong>Live Production:</strong> Vault contracts are deployed and fully operational on Somnia testnet.
              </span>
            </div>
          </div>
          ...
          {txHash && (
            <div className="bg-green-50 border border-green-200 rounded-lg p-3">
              ...
              <div className="mt-2 text-xs text-green-600">
                <strong>Live Somnia Testnet Transaction:</strong> This transaction interacts with deployed vault contracts on the live Somnia network (Chain ID: 50312).
              </div>
            </div>
          )}
          ...
          <div className="flex space-x-2">
            <button className="flex-1 bg-gradient-to-r from-blue-500 to-cyan-500 text-white py-1.5 sm:py-2 px-3 sm:px-4 rounded-lg hover:from-blue-600 hover:to-cyan-600 transition-all duration-200 flex items-center justify-center text-xs sm:text-sm">
              View Details
      ...
      {!isExpanded && (
        <div className="flex space-x-2 mt-auto">
          <button
            ...
            className="flex-1 bg-gradient-to-r from-blue-500 to-cyan-500 text-white py-1.5 sm:py-2 px-3 sm:px-4 rounded-lg hover:from-blue-600 hover:to-cyan-600 transition-all duration-200 flex items-center justify-center text-xs sm:text-sm"
          >
            <Plus className="w-3 h-3 sm:w-4 sm:h-4 mr-1" />
            Deposit
          </button>
          <button
            onClick={() => setIsExpanded(true)}
            className="flex-1 border border-gray-300 text-gray-700 py-1.5 sm:py-2 px-3 sm:px-4 rounded-lg hover:bg-gray-50 transition-all duration-200 flex items-center justify-center text-xs sm:text-sm"
          >
            <Minus className="w-3 h-3 sm:w-4 sm:h-4 mr-1" />
            Withdraw
          </button>
